...
namespace ShopForHome.Api.Migrations
{
    ...
    [Migration("20250905044402_RemoveDescriptionFromProduct")]
    partial class RemoveDescriptionFromProduct
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ShopForHome.Api.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FullName = "Admin User",
                            PasswordHash = "$2a$11$Qytm97fjMQ4t9TqBxaiqAOED3GsDSGtzXNCq/AQ/ROOyqzVW32rhO",
                            Role = "Admin"
                        });
                });
