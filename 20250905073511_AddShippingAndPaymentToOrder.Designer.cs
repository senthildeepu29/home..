...
namespace ShopForHome.Api.Migrations
{
    ...
    [Migration("20250905073511_AddShippingAndPaymentToOrder")]
    partial class AddShippingAndPaymentToOrder
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ShopForHome.Api.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FullName = "Admin User",
                            PasswordHash = "$2a$11$743T2yyyeFWP/ENph5GkZO8Y3uLk3fjwYxctwgDkC1CPx8kHXlWRG",
                            Role = "Admin"
                        });
                });
